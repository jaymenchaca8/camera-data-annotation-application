...
ResizableRectItem::ResizableRectItem(QRectF rect, ResizableRectItemSettings *settings, QGraphicsItem *parent)
...
void ResizableRectItem::changeColor(QColor _color) {
    settings->innerRectBrush.setColor(_color);
}

void ResizableRectItem::setClass(QString _class_name){
    class_name = _class_name;
}

QString ResizableRectItem::getClass() {
    return class_name;
}
