...
#include "../CameraDataAnnotationInterface/timelineview.h"
...
void timelineView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&timelineView::clicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject timelineView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_timelineView.data,
